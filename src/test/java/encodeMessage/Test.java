...
public class Test {
	...
	@org.junit.Test
	public void testC() {
		Assert.assertEquals("0 0 00 0000 0 00", Solution.encode("C"));
	}

	@org.junit.Test
	public void testCC() {
		Assert.assertEquals("0 0 00 0000 0 000 00 0000 0 00", Solution.encode("CC"));
	}

	@org.junit.Test
	public void testSpecialCharacter() {
		Assert.assertEquals("00 0 0 0 00 00 0 0 00 0 0 0", Solution.encode("%"));
	}
	...
	public void testChuckNorris() {
		Assert.assertEquals(
				...
				Solution.encode("Chuck Norris' keyboard has 2 keys: 0 and white space."));
